...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", async function () {
          ...
          beforeEach(async function () {
              ...
              await deployments.fixture(["all"]) // deploys everything in the deploy folder
          ...
          describe("Fund", async function () {
              ...
              it("Adds getFunders to array of getFunders", async function () {
                  await fundMe.fund({ value: sendValue })
          ...
          describe("withdraw", async function () {
              ...
              it("allows us to withdraw with multiple getFunders", async function () {
                  ...
                  // check to make sure getFunders array and mapping are empty
